  ...
  render() {
    return (
      <div>
        <link
          rel="stylesheet"
          href="https://use.typekit.net/urt8xoe.css"
        ></link>
        <link
          rel="stylesheet"
        ...
        <MediaQuery query="(max-width:767px)">
          <div style={{ position: "absolute", height: "180%", width: "100%" }}>
            ...
            <div
              style={{ position: "relative", top: "9%", paddingLeft: "14%" }}
            >
              <div className={styles.pMyName}>荻野 隼</div>
              <div style={{ fontSize: 18 }}>Jun Ogino</div>
            </div>
            ...
            >
              ...
              <p style={{ marginTop: 5 }}>
                ...
                <br></br>
                2016/04 電気通信大学 情報理工学域 I類
                メディア情報学プログラムに入学。
                <br></br>
                2020/04 電気通信大学を卒業し、同大学院 情報理工学研究科
                情報学専攻に入学。
                <br></br>
              ...
              <p style={{ marginTop: 5 }}>
                ...
                React
                Nativeを用いたネイティブアプリ開発、AR.jsを用いたARコンテンツの作成協力などに携わる。
                <br />
                大学院卒業後、株式会社ZOZOのiOSエンジニアとして新卒入社。
                ZOZOTOWNのネイティブアプリ開発に携わる。
              </p>
              <div style={{ fontSize: 20 }}>
            ...
            <div
              style={{ position: "relative", top: "14%", paddingLeft: "5%" }}
            >
              <IoIosRemove style={{ color: "#FFAB00", marginBottom: "3%" }} />
              Passion
            </div>
            ...
            <div
              style={{ position: "relative", top: "16%", paddingLeft: "5%" }}
            >
              <IoIosRemove style={{ color: "#FFAB00", marginBottom: "3%" }} />
              Skill set
            </div>
              ...
              <div className={styles.pSkillListContainer}>
                <div className={styles.pSkillInner}>
                  ...
                  <div className={styles.pSkillname}>
                    HTML / CSS / jQuery / React / Redux / Redux Saga / Vue /
                    Webpack
                  </div>
                </div>
                <div className={styles.pSkillInner}>
            ...
            <div className={styles.AboutTop}>
              ...
              <div className={styles.leftContainer}>
                <div className={styles.MyName}>
                  荻野 隼<div className={styles.MyNameEng}>Jun Ogino</div>
                </div>
              ...
              <div className={styles.rightContainer}>
                <div className={styles.rightInnerContainer}>
                  ...
                  <p>
                    大学入学後、学習の一環でC, Java, JavaScript,
                    pythonなどを学ぶ。<br></br>
                    B3の冬、スキル不足を感じインターンシップを開始。JavaScriptの基礎を実務を通して学び、React
                    Nativeを用いたネイティブアプリ開発、AR.jsを用いたARコンテンツの作成協力などに携わる。
                  </p>
                  <div className={styles.MyInfo}>
                  ...
                  <p>
                    大学の陸上競技部に所属し、現在も選手として活動中。<br></br>
                    2018年 第97回関東陸上競技大会<br></br>男子2部 十種競技
                    第6位入賞。
                  </p>
                </div>
              </div>
              ...
              <div className={styles.SkillListContainer}>
                <div className={styles.SkillInner}>
                  ...
                  <div className={styles.Skillname}>
                    HTML5 / CSS3 / jQuery / React / Redux / Redux Saga / Vue /
                    Webpack
                  </div>
                </div>
                <div className={styles.SkillInner}>
